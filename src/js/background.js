...
var lastTabs, lastWindow, paddingBottom, paddingTop, serialize, switcherWidth, switcherWindowId,
...
chrome.commands.onCommand.addListener(function(command) {
  if (command === "show-tab-switcher") {
    return chrome.windows.getCurrent(function(currentWindow) {
      ...
      return chrome.windows.create(windowOpts, function(switcherWindow) {
        return switcherWindowId = switcherWindow.id;
      });
    });
  }
});
